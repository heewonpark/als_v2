...
: Refered Roper P, Callaway J, Shevchenko T, TeruyamaR, Armstrong W
...
:https://senselab.med.yale.edu/ModelDB/ShowModel.cshtml?model=147514&file=/dendritic_complexity/cad.mod
